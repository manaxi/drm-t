(function() {
  ...
  let allVideos = [
    ...
    {
      name: 'Mano vaizdo įrašas',
      url: 'https://localhost:3000/Video1/Encrypted_Cenc/Manifest.mpd',
      keys: [
        {
          keyId: 'd6214010-142c-490b-b134-c81a87622ec3',
          key: 'ki1C/0Wpyn7NU35Zbd1Ubg=='
        }
      ]
    },
    {
      name: 'My video 1',
      url:
        'https://media.axprod.net/TestVectors/v6-MultiDRM/Manifest_1080p.mpd',
      keys: [
    ...
    // own videos to the list, copy-paste the custom video example above instead of this one.
    {
      ...
      licenseToken:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..1ie6MpTxLn8fNz29ERynMaMOnuRI2sSAxLhBysLybac'
    }
  ];
    ...
    if (video.keys) {
      ...
      video.keys.forEach(function verifyKey(item) {
        ...
        if (keyBuffer.length !== CONTENT_KEY_SIZE_IN_BYTES)
          throw new Error(
            'The content key must consist of 16 bytes of data, base64-encoded.'
          );
      });
    }
  }
